        ...
        <div class="card bg-base-100 w-full max-w-sm shrink-0 shadow-2xl">
          <form class="card-body">
            <div class="form-control">
              ...
              <div class="form-control">
						<label class="label" for="format_select">
							<span class="label-text text-gray-800">Download Format</span>
						</label>
						<select 
							name="format_select" 
						...
						>
							...
							<option value="epub_and_pdf">EPUB + PDF (Converted from EPUB)</option>
							<option value="both">Both (EPUB + PDF in ZIP)</option>
						</select>
					</div>
              {#if isPaidStory}
